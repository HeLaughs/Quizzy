<script lang="ts">
    ...
    onMount(() => {
      ...
      // Init posthog
      posthog.init('phx_kxAW3RouMDSlNvb2Wo5yRDOOzAPtqL1HvKE5JDMXYn39m1I', {
  ...
  <Header platformName="Quizzy AI" class="text-black" bind:isSideNavOpen>
    ...
    <HeaderUtilities>
      ...
      >
        <HeaderPanelLinks>
          ...
          <HeaderPanelLink
            href="mailto:support@quizzy.xyz"
            target="_blank"
            class="flex items-center"
          >
          ...
          <HeaderPanelLink
            href="https://x.com/BurbridgeJnr"
            target="_blank"
            class="flex items-center"
          >
            <SendAltFilled size={20} class="mr-2" />
            Tweet me @BurbridgeJnr
          </HeaderPanelLink>
        </HeaderPanelLinks>
      </HeaderAction>
    </HeaderUtilities>
